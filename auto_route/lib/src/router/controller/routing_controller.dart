...
class TabsRouter extends RoutingController implements ValueNotifier<int> {
  @override
  ...
  @override
  int get value => activeIndex;

  @override
  set value(int currentIndex) {
...
abstract class StackRouter extends RoutingController {
  ...
  Future<bool> pop<T extends Object?>([T? result]) async {
    ...
    if (navigator != null && await navigator.maybePop<T>(result)) {
      return true;
    } else if (_parent != null) {
      return _parent!.pop<T>(result);
    } else {
