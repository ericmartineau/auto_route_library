      ...
      ..body = Block((b) => b.statements.addAll([
            ...
            TypeReference(
              (b) => b
                ...
                ..url = autoRouteImport
                ..types.addAll([
                  r.returnType?.refer ?? refer('dynamic'),
                  if (r.routeType == RouteType.custom)
                    r.routeParametersType?.refer ?? refer('dynamic')
                ]),
            )
                .newInstance(
                  [],
                  {
                    ...
                    'child': constructedPage,
                    if (r.routeParameters != null)
                      'params': r.routeParameters!.refer,
...
extension DartObjectConstructExt on DartObject {}
